...
const SmartphonesSlider = () => {
  ...
  const smartPhones = Array.isArray(products)
    ? products.filter((product) => product.category_name === "სმარტფონები")
    : [];
...
export default SmartphonesSlider;
